    ...
    return(
        ...
        >
            ...
            <Link 
                ...
                <div 
                    // 加上 d-flex 與置中 class，讓內容漂亮地置中對齊
                ...
                >
                    {/* 加個大一點的 Icon 增加視覺引導 */}
                    <i className="bi bi-arrow-right-circle-fill mb-3" style={{ fontSize: '3rem', color: '#D4A373' }}></i>
                    <h4 className="fw-bold text-secondary text-center">探索更多<br/>熱門房屋</h4>
                </div>
            </Link>
        </div>
    )
