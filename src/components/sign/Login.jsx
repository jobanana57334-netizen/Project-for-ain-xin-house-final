    ...
    const {
        ...
        const onSubmit = async (data) => {
            try{
                ...
                // 🌟 新增：去 Firestore 抓取自訂名稱
                const customName= await fetchCustomName(loggedInUser.uid);

                // 決定要顯示什麼名字 (優先順序：自訂名稱 > Google 預設名稱 > Email 遮罩)
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="mb-4">
                    ...
                    <div className="position-relative">
                        ...
                        {/* 修正點 2：加入 d-block 確保訊息強制顯示，並確保放在 position-relative 內 */}
                        {errors.email && (
                ...
                {/* --- 修改點 2: 新增一個 Google 登入按鈕 --- */}
                {/* 或者你可以把它做得美美的放在下面 */}
                <div className="text-center mt-3">
                    <p>或</p>
                    <button 
                        type="button" // 重要！設為 button 才不會觸發表單驗證
